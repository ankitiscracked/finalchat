<template>
  <div class="project-popover" :style="positionStyle">
    ...
    <div v-else class="popover-content">
      ...
      <div class="new-project-form" :class="{ 'with-projects': projects.length > 0 }">
        <input 
...
import { addProject, getAllProjects } from '../../services/indexedDB';
...
const loadProjects = async () => {
  ...
  try {
    ...
    nextTick(() => {
      ...
      if (projects.value.length > 0 && projectItemRefs.value && projectItemRefs.value.length > 0) {
